  ...
  render(){
   return (
     <div>
       ...
       <img src="http://localhost:3001/rails/active_storage/blobs/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBDQT09IiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--acc925db802176365244a571a1c1ce428cafbdf9/3E53CB0A-5E94-4E01-B2BC-92241438BFBA.jpeg" alt="" width="33%" height="33%"style={{padding: "25px"},{border: "10px double black"}}></img>
